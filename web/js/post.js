    ...
    $.get("post", {"opc": 1}, function (data) {
        ...
        for (let i = 0; i < x.length; i++) {
            $("#tablita").append(
                    ...
                    "</td><td><a href='#' onclick='read(" + x[i].idpost + ")'><i class='fa-solid fa-pen-to-square color1'></i></a></td><td><a href='#' \n\
onclick='eliminar(" + x[i].idpost + ")'><i class='fa-solid fa-trash-can color2'></i></a></td></tr>");
        }
